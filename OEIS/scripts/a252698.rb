# A252698: Number of strings of length n over a 5 letter alphabet that do not 
...
# print "For n = #{b}, the first 10 of the a(#{3}) = #{seq[3]} solutions are (in lexicographic order): #{first_ten(b).join(", ")}\n\n"
