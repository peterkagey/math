...
###############################################
require_relative '../../scripts/helpers/sums_and_differences'
...
class TreeBuilder
  ...
  def tree
    ...
    right_tree = TreeBuilder.new(sub_tree_size).tree
    left_tree = TreeBuilder.new(@size - sub_tree_size - 1).tree
